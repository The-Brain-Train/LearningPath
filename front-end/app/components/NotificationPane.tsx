...
const NotificationPane = (props: NotificationPaneType) => {
  const [openSuggestedResourseBox, setOpenSuggestedResourseBox] =
    useState(false);
  const [curNotificationOption, setCurNotificationOption] = useState(-1);
  const [currentNotification, setCurrentNotification] =
    useState<NotificationType | null>(null);
  const [unreadCount, setUnreadCount] = useState(0);
  const handleCloseSuggestedResourseBox = () =>
    setOpenSuggestedResourseBox(false);
    ...
    <>
      <div className="relative mx-1 md:mx-6">
        ...
        {props.notificationsVisible && (
          <div
            onBlur={handleCloseSuggestedResourseBox}
            className="absolute w-72 md:w-96 right-0 bg-white rounded-md shadow-xl z-10 overflow-y-auto max-h-80"
          >
            {allNotifications &&
                  ...
                  <div className="flex flex-row justify-between">
                    ...
                    <div className="flex flex-col items-end">
                      <MoreHorizIcon
                        ...
                        onClick={(e) =>
                          handleNotificationMoreButtonClick(e, n, index)
                        }
                      />
                      {curNotificationOption === index && (
                        <div
                          ...
                          onMouseLeave={() =>
                            handleNotificationMoreMouseLeaveClick(index)
                          }
                        >
                          <ul className="text-sm">
                            ...
                            <li
                              className="hover:bg-slate-300 p-1"
                              onClick={(e) =>
                                handleNotificationDeleteClick(e, n)
                              }
                            >
                              Delete
                            </li>
