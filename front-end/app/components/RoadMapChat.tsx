...
//                 <button type="button" className="inline-flex items-center justify-center rounded-lg p-3 transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none">
      ...
      const chatHistory = [...messages, { role: "user", content: userMessage }]
        ...
        try {
            ...
            if (response.choices && response.choices.length > 0) {
                ...
                setMessages([
                  ...chatHistory, {role: "assistant", content: response.choices[0].message.content}
                ])
            }
        } catch (error) {
