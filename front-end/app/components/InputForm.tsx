  ...
  return (
    <>
      <div>
        ...
        <button  className="bg-transparent hover:bg-emerald-600 text-lg text-lime-400 font-bold border-2 border-white rounded  animate-pulse" onClick={handleOpen}>Click to create Roadmap</button>
        </div>
        <Modal
          open={open}
          onClose={handleClose}
